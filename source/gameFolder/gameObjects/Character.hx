	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
			case 'derg':
				frames = Paths.getSparrowAtlas('characters/fogupiano');
				animation.addByPrefix('idle', 'fogu idle', 24, false);
				animation.addByPrefix('singUP', 'fogu up', 24);
				animation.addByPrefix('singRIGHT', 'fogu right', 24);
				animation.addByPrefix('singDOWN', 'fogu down', 24);
				animation.addByPrefix('singLEFT', 'fogu left', 24);
